/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 199786fba21d1d2f30fe9f0cf44e60df)
// Runtime types generated with workerd@1.20260801.1 2026-08-05 nodejs_compat
interface __BaseEnv_Env {
	BUCKET: R2Bucket;
	DB: D1Database;
	ORDER_LOOKUP_LIMITER: RateLimit;
	PAYMENT_REFRESH_LIMITER: RateLimit;
	ORDER_CLAIM_LIMITER: RateLimit;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "MAYAR_ENVIRONMENT" | "SHIPPING_FLAT_RATE" | "BETTER_AUTH_SECRET" | "SETUP_TOKEN" | "MAYAR_API_KEY">> {}
}
